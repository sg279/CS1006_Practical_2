...
public abstract class Buildable {
     ...
     * For buildings that don't produce units the same check is done but instead of checking if a certain number has started to be built it is only checked if 1 has been built.
    ...
    /**
     * This method is called when a unit is built in a game state. For buildings that don't produce units, the method increments the gamestate's value for that building.
     ...
     * For assimilators, if the number of available probes is greater than or equal to 3, the number of available probes is reduced by three and the number of gas miners
